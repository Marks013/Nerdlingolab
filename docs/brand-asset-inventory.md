# Inventário de assets tema legado
...
- Copiar para `public/brand-assets/` somente assets usados pela aplicação.
...
| `assets/theme.min.js` | Não migrar; lógica Liquid/tema legado não deve entrar no Next.js. |
...
| `assets/provedor-legado-fidelidade-integration.js` | Não migrar; fidelidade atual usa domínio próprio. |
