...
Fonte: tema legado exportado em `C:\Users\samue\Desktop\theme_export__nerdlingolab-com-nerdlingolav-v11-9-5__24APR2026-1138am.zip`
...
| `sections/provedor-legado-fidelidade-loyalty-page.liquid` | `src/app/(shop)/programa-de-fidelidade/page.tsx` | Parcial | Nerdcoins já existem; pode herdar tom visual do provedor legado de fidelidade sem scripts externos. |
...
- `ShopFooter` migra a intenção do footer tema legado: barra colorida, atendimento, links, pagamento seguro e entrega acompanhada.
...
- Nenhum script tema legado foi importado.
