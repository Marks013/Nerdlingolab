# Blueprint Shopify -> NerdLingoLab com base SavePointFinance

## Contexto

Este projeto substitui o tema Shopify exportado em:
...
## Inventário do Shopify exportado
...
1. Consolidar identidade Shopify no Next.js
...
- Não importar Liquid como código de produção; usar o tema Shopify como referência visual e funcional.
...
1. Criar inventário detalhado dos assets Shopify que entram em `public/`.
2. Comparar a home Shopify com `src/app/(shop)/page.tsx`.
