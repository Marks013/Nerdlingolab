  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      {favorites.map((product) => (
        <Link className="motion-lift manga-panel rounded-lg bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md" href={`/produtos/${product.slug}`} key={product.id}>
